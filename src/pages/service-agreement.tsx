export default function ServiceAgreement() {
    return (
        <div className="h-screen bg-white p-4 text-[#333333] overflow-auto">
            <h4 className="text-base font-bold mb-2">服务使用协议</h4>
            <div className="leading-6 text-sm">
                <p className="[text-indent:2em]">欢迎使用“AI小虹”人才政策咨询服务!</p>
                <p className="mb-2 [text-indent:2em]">本协议是您(以下简称"用户")与“虹口区人才服务中心”(以下简称"我们"或"服务提供方")之间就您使用“AI小虹”提供的移动端人才政策咨询服务(以下简称"本服务")所订立的法律协议。请务必认真阅读、充分理解本协议中各条款,包括免除或者限制服务提供方责任的条款及对用户的权利限制条款。您一旦点击"同意"并完成注册程序,即表示您已接受本协议的所有内容,并同意受其约束。如果您不同意本协议的任何内容,或者无法准确理解相关条款,请不要进行后续操作。</p>
